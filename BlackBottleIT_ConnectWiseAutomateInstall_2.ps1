...
$msiArguments = "/quiet /norestart /log C:\Windows\Temp\Automate_Install.log SERVERADDRESS=https://blackbottle.hostedrmm.com SERVERPASS=133JZzziS4IpHkHgveYOwRIGj8PihZ8n LOCATION=32"
